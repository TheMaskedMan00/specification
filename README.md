...
What is this? This is a community-driven "OpenAPI" (formerly  Swagger) specification. (fixed for C#) OpenAPI allows to define an API in YAML - a both machine and human-readable format - and then do tons of cool stuff with it! While our primary use is automatically generating the website docs from the specification, we can also use it to automatically generate code! Fully working code!
